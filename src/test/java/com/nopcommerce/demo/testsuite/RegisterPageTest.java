...
public class RegisterPageTest extends TestBase {
    ...
    public void verifyThatUserShouldCreateAccountSuccessfully(){
        ...
        registerPage.inputFirstName("Mahesh");
        registerPage.inputLastName("Patel");
        registerPage.selectDateOfBirth("1","January","1985");
        registerPage.inputEmail("MaheshPatel2021@gmail.com");
        registerPage.inputPassword("Temp12345");
        registerPage.inputConfirmPassword("Temp12345");
        registerPage.clickOnRegisterButton();
